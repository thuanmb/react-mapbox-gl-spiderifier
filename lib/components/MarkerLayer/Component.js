...
var _ComponentUtilities = require('ComponentUtilities');
...
var MarkerLayer = function (_Component) {
	...
	_createClass(MarkerLayer, [{
		...
		value: function componentWillReceiveProps(nextProps) {
			...
			if (nextProps.children !== this.props.children || (0, _ComponentUtilities.checkPropsChange)(this.props, nextProps, ['style', 'className'])) {
		...
		value: function _bindEvents() {
			...
			var events = (0, _ComponentUtilities.extractEventHandlers)(this.props);
			this.realHandlers = {};
			_lodash2.default.forEach(events, function (handler, name) {
				var realHandler = _this3._generateEventHander(name);
				_this3.element.addEventListener((0, _ComponentUtilities.getExactEventHandlerName)(name), realHandler);
		...
		value: function _unbindEvents() {
			...
			_lodash2.default.forEach(events, function (handler, name) {
				...
				_this4.element.removeEventListener((0, _ComponentUtilities.getExactEventHandlerName)(name), realHandler);
			});
