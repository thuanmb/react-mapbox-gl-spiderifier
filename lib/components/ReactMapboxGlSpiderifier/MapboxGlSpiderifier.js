...
var MapboxGlSpiderifier = function (_Component) {
	...
	_createClass(MapboxGlSpiderifier, [{
		...
		value: function _getSpiderifierMarkers() {
			...
			var eventHanders = (0, _ComponentUtilities.extractEventHandlers)(this.props);
		...
		value: function _updateSpiderParams(nextProps) {
			if ((0, _ComponentUtilities.checkPropsChange)(this.props, nextProps, ['children', 'circleFootSeparation', 'circleSpiralSwitchover', 'spiralFootSeparation', 'spiralLengthStart', 'spiralLengthFactor', 'transformSpiderLeft', 'showingLegs'], _lodash2.default.isEqual)) {
				this.setState({
